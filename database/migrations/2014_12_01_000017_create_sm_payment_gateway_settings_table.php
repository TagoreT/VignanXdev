    ...
    public function up(): void
    {
        ...
        DB::table('sm_payment_gateway_settings')->insert([
            [
                ...
                'gateway_password' => '12334589',
                'gateway_client_id' => '',
                'gateway_secret_key' => env('STRIPE_SECRET_KEY', 'sk_test_your_stripe_secret_key_here'),
                'gateway_publisher_key' => env('STRIPE_PUBLISHABLE_KEY', 'pk_test_your_stripe_publishable_key_here'),
                'created_at' => date('Y-m-d h:i:s'),
